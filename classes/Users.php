...
Class Users extends DBConnection {
	...
	public function save_users(){
		...
		if(empty($id)){
			...
			if($qry){
				$this->settings->set_flashdata('success','Detalhes do usuário salvos com sucesso.');
				return 1;
			}else{
				return 2;
			}
	...
	public function delete_users(){
		...
		if($qry){
			$this->settings->set_flashdata('success','Detalhes do usuário excluídos com sucesso.');
			return 1;
