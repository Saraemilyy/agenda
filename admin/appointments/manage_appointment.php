    ...
    <div class="row" id="appointment">
        <div class="col-6" id="frm-field">
            ...
            <input type="hidden" name="patient_id" value="<?php echo isset($patient_id) ? $patient_id : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <option <?php echo isset($patient['gender']) && $patient['gender'] == "Male" ? "selected": "" ?>>Masculino</option>
                    <option <?php echo isset($patient['gender']) && $patient['gender'] == "Female" ? "selected": "" ?>>Feminino</option>
                    </select>
                </div>
                <div class="form-group">
        ...
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="procedure" rows="3" required><?php echo isset($procedure)? $procedure : "" ?></textarea>
            </div>
            ...
            <?php endif; ?>
            <div class="form-group">
                <label for="date_sched" class="control-label">Data da consulta</label>
