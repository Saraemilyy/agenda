...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Agendar Consulta</a>
		</div>
	</div>
	<div class="card-body">
        <div class="container-fluid">
			<div class="row" style="display:none" id="selected_opt">
				<div class="w-100 d-flex">
					<div class="col-2">
						<label for="" class="controllabel"> Com selecionado:</label>
					</div>
					<div class="col-3">
				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td><?php echo date("d-m-Y H:i ",strtotime($row['date_sched'])) ?></td>
							<td class="text-center">
								<?php 
								switch($row['status']){ 
									case(0): 
...
<script>
	...
	$(document).ready(function(){
		...
		$('.view_data').click(function(){
			uni_modal("Detalhes da consulta","appointments/view_details.php?id="+$(this).attr('data-id'))
		},
	
		)
		$('#create_new').click(function(){
			uni_modal("Formulário de Consultas","appointments/manage_appointment.php",'mid-large')
		})
		$('.edit_data').click(function(){
			uni_modal("Editar detalhes da consulta","appointments/manage_appointment.php?id="+$(this).attr('data-id'),'mid-large')
		})
