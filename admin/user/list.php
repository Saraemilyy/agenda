...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Criar Novo</a>
		</div>
	</div>
	<div class="card-body">
		<div class="container-fluid">
        <div class="container-fluid">
		<table class="table table-bordered table-stripped" id="indi-lista">
				<thead>
					<tr>
						<th>ID</th>
						<th>Foto</th>
...
<script>
	...
	$(document).ready(function(){
		...
		$('.delete_data').click(function(){
			_conf("Deseja deletar esse usuário permanentemente?","delete_user",[$(this).attr('data-id')])
		}),
