	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			...
			<!-- <div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_department" href="javascript:void(0)"><i class="fa fa-plus"></i> Adicionar Novo</a>
			</div> -->
		</div>
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Nome abreviado do sistema</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logo do sistema</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Capa do site</label>
				<div class="custom-file">
